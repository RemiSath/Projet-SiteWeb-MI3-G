<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $id = $_POST["id"] ?? null;
        $nouveauStatut = $_POST["action"] ?? null;
...
<main class="container">
    ...
    <div class="filters">
        ...
        <a class="filter-btn2" href="commandes.php?statut=en_attente_livreur">En attente d'un livreur (<?php echo $compteurs["en_attente_livreur"]; ?>)</a>
            ...
            <div class="details">
                ...
                <div class="actions">
                    <form method="POST">
                        ...
                        <?php if ($statut === "a_preparer") { ?>
                            <button class="btn2 primary" name="action" value="en_attente_livreur">Mettre en attente livreur</button>

                        <?php } elseif ($statut === "en_attente_livreur") { ?>
                            <button class="btn2 primary" name="action" value="en_livraison">Mettre en livraison</button>

                        <?php } elseif ($statut === "en_livraison") { ?>
                            <button class="btn2 success" name="action" value="livree">Marquer livrée</button>
